...
async function getAbout() {
    ...
    let response = await fetch('https://ernestruzindana-api.herokuapp.com/getAbout', getOptions)
...
fetch("https://ernestruzindana-api.herokuapp.com/updateAbout", sendData)

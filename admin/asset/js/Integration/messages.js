...
let deleteMessage= async() => {
    ...
    let response = await fetch('https://ernestruzindana-api.herokuapp.com/contact/deleteMessage/'+messageIdDeletion, deleteOptions)
...
async function fetchMessages(){
    ...
    let response = await fetch("https://ernestruzindana-api.herokuapp.com/contact/getAllMessages")
...
let getSingleMessage= async(messageId) => {
    ...
    let response = await fetch('https://ernestruzindana-api.herokuapp.com/contact/getMessageById/'+messageId, getOptions)
